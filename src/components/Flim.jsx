                ...
                <div className='blockWrap'>
                    <div className="block1">
                        ...
                        <div className="subContent">
                            2019年底COVID-19爆發後，全球紛紛歷經封城及解封的循環，
                            民眾居家時間大幅增加，對於影視收視和遊戲等娛樂的需求也隨
                            之上升。國際影視串流平臺本就在近年積極佈局全球，疫情助推
                            了對串流影視內容的收視需求，也讓國際串流服務業者在搶食各
                            國影視內容消費市場的同時，加速調整拓展策略。
                        </div>
                    </div>
                        ...
                        <div className='imgWrap'>
                            ...
                            <div className="text">
                                    ...
                                    <div className='black_text'>
                                        法國為維護本土電視頻道的生存，另針對窗口期推出適用於付費電視、
                                        免費電視及訂閱服務的新規定：過去36個月的院線窗口期調整為15至17
                                        個月，而法國免費電視頻道享有1個月的獨家播映窗口期。
                                    </div>

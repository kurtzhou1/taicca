                ...
                <div className='blockWrap'>
                    <div className="block1">
                        ...
                        <div className="subContent">
                            當全球名人都風風火火地在「元宇宙」開演唱會、
                            購地、開店，把現實中的品牌搬到虛擬空間究竟怎
                            麼操作？感覺和玩大富翁有多像呢？本文衍伸自
                            《2021年臺灣文化內容產業調查報?IV：遊戲、電競產業》，
                            商人摸索出遊戲與運動在競技形構的相似，以開發足球電競來
                            擴大實體賽季效益早已不是新鮮事。隨著沉浸式科技與社群
                            文化的日益成熟，無論在產業端的聯盟或消費端的金流機制
                            方面，元宇宙的新商模都還有賴更多方合作的探索與突破。
                        </div>
                    </div>

                ...
                <div className='blockWrap'>
                    <div className="block1">
                        ...
                        <div className="subContent">
                            根據國際唱片業協會報告顯示，音樂產業線上產值在2021年達到整體產值的67%，時至2022年，線上產值將突破七成，消費型態、版權與商業模式等也在持續變化中。新技術概念的加入，更讓未來趨勢走向多元。文策院今年推出的《2021年臺灣文化內容產業調查告III：流行音樂、廣播產業》介紹音 樂產業的三種新商業模式，有近二年最火熱的NFT話題、歌曲 版權投資與利用音樂版權指數的交易平臺。
                        </div>
                    </div>
